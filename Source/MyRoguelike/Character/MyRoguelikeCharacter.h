...
#include "MyRoguelikeCharacter.generated.h"
...
class AMyRoguelikeCharacter : public ACharacter
{
	...
	TArray<TSubclassOf<USkillBase>> SkillInfos;
...
public:
	...
	FORCEINLINE const TArray<TObjectPtr<USkillBase>> &GetSkills() const { return Skills; }
